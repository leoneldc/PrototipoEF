...
import comercial.datos.BancoDAO;
 ...
 */
public class mBancos extends javax.swing.JInternalFrame {
    ...
    void actualizarTabla() {
        ProcesosRepetidos pr = new ProcesosRepetidos();
        String columnas[] = {"ID", "NOMBRE", "UBICACIÓN", "ESTADO"};
        ...
        int tamaño[] = {50, 250, 250, 150};
        BancoDAO dao = new BancoDAO();
        List<Bancos> bancos = dao.select();
        for (Bancos banco : bancos) {
            datos[0] = banco.getCodigo();
            datos[1] = banco.getNombre();
            datos[2] = banco.getUbicacion();
            if (banco.getEstado().equals("1")) {
                datos[3] = "Activo";
            } else {
                datos[3] = "Inactivo";
            }
    ...
    void buscar() {
        ...
        List<Bancos> bancos = dao.select();
        for (Bancos banco : bancos) {
            if (banco.getCodigo().equals(jTextField4.getText())) {
                datos[0] = banco.getCodigo();
                datos[1] = banco.getNombre();
                datos[2] = banco.getUbicacion();
                if (banco.getEstado().equals("1")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (pr.isNumeric(jTextField1.getText())) {
            if (pr.isNoneEmpty(jTextField1, jTextField2, jTextField3)) {
                if (pr.isSelected(jRadioButton1, jRadioButton2)) {
                    BancoDAO dao = new BancoDAO();
                    vbanco.setCodigo(jTextField1.getText());
                    vbanco.setNombre(jTextField2.getText());
                    vbanco.setUbicacion(jTextField3.getText());
                    ...
                    dao.insert(vbanco);
                    bitacora.GuardarEnBitacora("insertar", "2001");
                    actualizarTabla();
                    limpiar();
                    pr.AlertaMensaje("guardado", "Banco", "exitosamente");
                }
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (pr.isNumeric(jTextField1.getText())) {
            if (pr.isNoneEmpty(jTextField1)) {
                if (pr.ConfirmarEliminacion("eliminar", "banco", this)) {
                    BancoDAO dao = new BancoDAO();
                    vbanco.setCodigo(jTextField1.getText());
                    dao.delete(vbanco);
                    bitacora.GuardarEnBitacora("eliminar", "2001");
                    actualizarTabla();
                    limpiar();
                    pr.AlertaMensaje("eliminado", "Banco", "exitosamente");
                }
            }
        }
        ...
        if (pr.isNumeric(jTextField1.getText())) {
            if (pr.isNoneEmpty(jTextField1, jTextField2, jTextField3)) {
                if (pr.isSelected(jRadioButton1, jRadioButton2)) {
                    ...
                    dao.update(vbanco);
                    actualizarTabla();
                    bitacora.GuardarEnBitacora("modificar", "2001");
                    limpiar();
                    pr.AlertaMensaje("guardado", "Banco", "exitosamente");
                }
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            bitacora.GuardarEnBitacora("seleccionar", "2001");
            ...
            if (jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString().equals("Activo")) {
