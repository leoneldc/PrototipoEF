...
import comercial.datos.CuentaContableDAO;
 ...
 */
public class CuentaContable extends javax.swing.JInternalFrame {

    ProcesosRepetidos pr = new ProcesosRepetidos();
    CuentasContables vcuenta = new CuentasContables();
    ...
    /**
     * Creates new form CuentaContable
     */
    ...
    void actualizarTabla() {
        ProcesosRepetidos pr = new ProcesosRepetidos();
        String columnas[] = {"ID", "NOMBRE", "CLAS", "MONTO", "ESTADO"};
        ...
        int tamaño[] = {50, 250, 350, 150, 150};
        CuentaContableDAO dao = new CuentaContableDAO();
        List<CuentasContables> cuentas = dao.select();
        for (CuentasContables cuenta : cuentas) {
            datos[0] = cuenta.getCodigo();
            datos[1] = cuenta.getNombre();
            if (cuenta.getClasf().equals("1")) {
                datos[2] = "Activo";
            } else {
                datos[2] = "Pasivo";
            }
            datos[3] = cuenta.getDescripcion();
    ...
    void buscar() {
        ...
        List<CuentasContables> cuentas = dao.select();
        for (CuentasContables cuenta : cuentas) {
            if (cuenta.getCodigo().equals(jTextField4.getText())) {
                datos[0] = cuenta.getCodigo();
                datos[1] = cuenta.getNombre();
                if (cuenta.getClasf().equals("1")) {
                    datos[2] = "Activo";
    ...
    private void initComponents() {
        ...
        jRadioButton4.setText("ACTIVIVO");

        buttonGroup1.add(jRadioButton5);
        jRadioButton5.setText("PASIVO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (pr.isNumeric(jTextField1.getText())) {
            if (pr.isNoneEmpty(jTextField1, jTextField2)) {
                if (pr.isSelected(jRadioButton1, jRadioButton2)) {
                    if (pr.isSelected(jRadioButton4, jRadioButton5)) {
                        CuentaContableDAO dao = new CuentaContableDAO();
                        vcuenta.setCodigo(jTextField1.getText());
                        vcuenta.setNombre(jTextField2.getText());
                        vcuenta.setDescripcion(jTextField5.getText());
                        ...
                        dao.insert(vcuenta);
                        actualizarTabla();
                        bitacora.GuardarEnBitacora("insertar", "2003");
                        limpiar();
                        pr.AlertaMensaje("guardado", "Cuenta Contable", "exitosamente");
                    }
                }
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (pr.isNumeric(jTextField1.getText())) {
            if (pr.isNoneEmpty(jTextField1)) {
                if (pr.ConfirmarEliminacion("eliminar", "cuenta contable", this)) {
                    CuentaContableDAO dao = new CuentaContableDAO();
                    vcuenta.setCodigo(jTextField1.getText());
                    dao.delete(vcuenta);
                    ...
                    actualizarTabla();
                    limpiar();
                    pr.AlertaMensaje("eliminado", "cuenta contable", "exitosamente");
                }
            }
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString().equals("Activo")) {
                jRadioButton4.setSelected(true);
            } else {
                jRadioButton5.setSelected(true);
            }
            jTextField5.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
            if (jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString().equals("Activo")) {
                jRadioButton1.setSelected(true);
            } else {
                jRadioButton2.setSelected(true);
            }
            bitacora.GuardarEnBitacora("seleccionar", "2003");
        }
